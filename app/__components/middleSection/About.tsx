...
const About = () => {
  return (
    <div id="about" className="w-full flex justify-center">
      <div className="w-[84%] flex flex-row items-center mt-[10%] relative">
        <div className="flex flex-col text-text leading-none w-3/5">
          <span className="font-bold text-[2rem] tracking-wider text-primary mb-6">About Me</span>
        ...
        <div className="w-2/5 flex justify-center z-50">
          <Image
            src={headshot}
            alt="Placeholder Headshot"
            className="w-3/4 object-cover grayscale hover:grayscale-0 hover:scale-105 transition duration-300 ease-in-out"
          />
        </div>
      </div>
    </div>
