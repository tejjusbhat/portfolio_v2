...
const Hero = () => {
  ...
  return (
    <div id="home" className="relative w-full h-screen px-4 md:px-0">
      ...
      <div className="absolute left-[50%] transform translate-x-[-50%] bottom-[50%] flex justify-center items-center z-0">
        <span
      ...
      <div className="absolute bottom-0 right-10 flex justify-center items-center z-10">
        <Image
          src={headshot}
          alt="Headshot"
          width={600}
      ...
      <div className="relative flex flex-col w-full h-screen justify-end gap-10 items-start pb-[5rem] z-20 px-32">
        {/* Left Section with smaller text */}
        <div className="w-1/2 flex flex-col text-text leading-none justify-center items-start">
